...
One can opt into the new statisics during configuration.

Disabled: (default) then the integration works has it has until know.

Enabled: then the integration create one new entity `sensor.eloverblik_energy_statistic`
and removes the old energy entities. [Read more](#long-term-statistics-and-energy-dashboard) 
